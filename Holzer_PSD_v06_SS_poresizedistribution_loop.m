...
inpath =  '/home/karenchen-wiegart/ChenWiegart_Group/Xiaoyang/201909FXI_align/seg_ig_xy/'
prefix = {'30598_seg[1.4479909]_30598'}
phase_name = 'Ni'
phase = 255;


%voxel_size = 20.28 ;  %need to match the actual data - reconstruction voxel size is 2x of raw data (bin=2 in recon)
voxel_size = 43.34;  %need to match the actual data - reconstruction voxel size is 2x of raw data (bin=2 in recon)
...
file_beg = 1;
file_end = 300; %number of images in the image stack
file_x = 720;
file_y = 690;
...
%output file information
    rs_step = 1
    factor = 1
    outpath = '/home/karenchen-wiegart/ChenWiegart_Group/Xiaoyang/201909FXI_align/NiFSD_xy/'
    outprefix = [s, 'withNorm_rs_', num2str(rs_step), '_factor_', num2str(factor)]
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

    textname = ['NiFSD_',outprefix];
    excelfile = [outpath, textname(1:11), '.xlsx']
    textfile = [outpath, textname(1:11), '.txt']
    sheet_name = phase_name

    matfile_name = [outpath, textname(1:11), phase_name, '.mat']
    ...
    switch input_data_dimension 
        ...
        case 2
            ...
            for i=1:file_z
                ...
                img(:,:,i) = imread([inpath,s,num],'tiff');
            end
    ...
    %xlswrite( excelfile, {['data input:',inpath, s]}, sheet_name, 'A1')
    ...
    zeroscolumn = {'0';'0';'0';'0'} 
    xlswrite( excelfile, fieldname', sheet_name, 'B1')
    xlswrite(  excelfile, zeroscolumn', sheet_name, 'B2')
    xlswrite( excelfile, rs_array_nm', sheet_name, 'B3')
    xlswrite( excelfile, Rrs_vol_accum', sheet_name, 'C3')
    xlswrite( excelfile, Rrs_vol_fract', sheet_name, 'D3')
    xlswrite( excelfile, Rrs_vol_fract_norm', sheet_name, 'E3')
